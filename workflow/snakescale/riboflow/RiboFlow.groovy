...
process filter{
    ...
    bowtie2 ${params.alignment_arguments.filter} \
            ...
            && samtools index ${sample}.${index}.filter.bam \
            && samtools idxstats ${sample}.${index}.filter.bam  > \
...
process transcriptome_alignment{
    ...
    bowtie2 ${params.alignment_arguments.transcriptome} \
            ...
            && samtools index ${sample}.${index}.transcriptome_alignment.bam \
            && samtools idxstats ${sample}.${index}.transcriptome_alignment.bam  > \
...
process quality_filter{
	...
	&& samtools index ${sample}.${index}.transcriptome_alignment.qpass.bam \
	&& samtools idxstats ${sample}.${index}.transcriptome_alignment.qpass.bam  > \
...
process genome_alignment{
    ...
    hisat2 ${params.alignment_arguments.genome} \
           ...
           && samtools index ${sample}.${index}.genome_alignment.bam \
...
process post_genome_alignment{
  ...
  bowtie2 ${params.alignment_arguments.transcriptome} \
          ...
          && samtools index ${sample}.${index}.postgenome_alignment.bam \
          && samtools idxstats ${sample}.${index}.postgenome_alignment.bam  > \
